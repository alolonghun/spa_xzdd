<template>
    ...
    <ul class="m-lesson dk link" v-show="showDK" v-infinite-scroll="dkloadMore()" infinite-scroll-disabled="dkallDone" infinite-scroll-distance="10">
        ...
        ghloadMore: function(event) {
          ...
          if (!$this.ghloadFlag) {
            ...
            if ($this.ghpage > $this.ghallPage) {
              ...
              $.ajax({
                url: $ApiConf.api_user_subscribe_list,
                data: {
                  "page": $this.ghpage,
                  "page_num": 10,
                  "type": 2,
